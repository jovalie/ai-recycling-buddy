...
system_relevant_scope = "proper recycling and waste management queries, optimizing household waste sorting systems, maintaining compliance with local recycling regulations in Germany and the United States"
